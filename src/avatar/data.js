...
export const FALLBACK_PRESETS = {
  ...
  surprised: pose("jump", "surprised", "startle", { transitionMotion: "quick_react", loop: false, priority: 40, blinkMode: "special", breathScale: 0.8, pose: { x: 0, y: -4, rotation: -1, scale: 1.01 } }),
  embarrassed: pose("stand", "embarrassed", "shy_shift", { breathScale: 0.9, pose: { x: -2, y: 3, rotation: 2, scale: 1 } }),
  scared: pose("uruuru", "scared", "scared_shiver", { transitionMotion: "quick_react", blinkMode: "special", breathScale: 0.8, pose: { x: 0, y: 5, rotation: -1, scale: 0.99 } }),
